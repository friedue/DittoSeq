...
#' This is the data that will be displayed for each cell/sample. Discrete or 
#' continuous data both work.
#'
#' Alternatively, can be a vector of same length as there are cells/samples in 
#' the \code{object}.
